...
def draw_high_scores():
    ...
    high_score_image = pygame.transform.scale(high_score_image, (WIDTH, HEIGHT))
...
def draw_instructions():
    # Load backgorund
    instruction_image = pygame.image.load("instruction_background.png").convert_alpha()
    instruction_image = pygame.transform.scale(instruction_image, (WIDTH, HEIGHT))
